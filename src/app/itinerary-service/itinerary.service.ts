  ...
  readonly days = signal<Day[]>([
    {
      ...
      travel: {
        ...
        routes: [[
          ...
          { emoji: '🚶 🚕', duration: '4 mins / 1 mins', title: 'Tokyo accommodation', description: "Walk 300m to 'Home in Shinjuku City, Hosted by Naomi' (Airbnb)", address: "1-chōme-16-16 Ōkubo, Shinjuku City, Tokyo 169-0072" }
        ]]
      },
      activities: [
      ...
      travel: {
        ...
        routes: [
          ...
          [
            ...
            { emoji: '🚶 🚕', duration: '4 mins / 1 mins', title: 'Tokyo accommodation', description: "Walk 300m to 'Home in Shinjuku City, Hosted by Naomi' (Airbnb)" }
          ]
        ]
      }
    },
    {
      ...
      travel: {
        ...
        routes: [[
          ...
          { emoji: '🚶 🚕', duration: '5 mins / 2 mins', title: 'Kyoto accommodation', description: "Walk 400m to 'House in Kyoto, Hosted by Sao'" }
        ]]
      },
      activities: [
    ...
    },
    {
      ...
      travel: {
        ...
        routes: [[
          ...
          { emoji: '🚶 🚕', duration: '4 mins / 2 mins', title: 'Osaka accommodation', description: "Walk 300m to 'Home in Ikuno Ward, Osaka, Hosted by Takeshi'" }
        ]]
      }
    },
    {
    ...
    },
    {
      ...
      travel: {
        ...
        routes: [[
          ...
          { emoji: '🚶 🚕', duration: '4 mins / 2 mins', title: 'Return to Osaka accommodation', description: "Walk / taxi to 'Home in Ikuno Ward, Osaka, Hosted by Takeshi'" }
        ]]
      }
    },
    {
      ...
      travel: {
        ...
        routes: [[
          ...
          { emoji: '🚶 🚕', duration: '5 mins / 3 mins', title: 'Tokyo accommodation #2', description: "Walk 350m to 'Via Inn Shinjuku' (Hotel)" }
        ]]
      }
    },
    {
